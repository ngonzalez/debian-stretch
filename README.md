...
# gcloud compute ssh --zone $ZONE ngonzalez@gke-app-default-pool-934a4208-fdwj --project $PROJECT_NAME --container=1e36479e271e
```

```
ssh -J <GCLOUD_USER>@<NODE_EXTERNAL_IP> <USER>@<POD_IP>
# ssh -J ngonzalez@35.228.245.113 debian@10.76.0.12
```
